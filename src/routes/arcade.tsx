...
const GameIcon = () => (
  ...
  >
    <path d="m6 12 4-9 4 9H6Z" />
    <path d="M6 12c.38 2.56 1.88 4.5 4 4.5s3.62-1.94 4-4.5H6Z" />
    <path d="M9 16.5V21h2v-4.5" />
    <path d="M13 16.5V21h2v-4.5" />
    <path d="M5 9c-1.5 1.5-3 1-3 1" />
    <path d="M19 9c1.5 1.5 3 1 3 1" />
  </svg>
);
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl">
        ...
        >
          ...
          <p className="text-gray-400 text-sm leading-relaxed">
            Försvara galaxen mot fallande trianglar. Klassisk arkad-action.
          </p>
      ...
      <div className="relative border-4 border-gray-800 rounded-lg shadow-[0_0_50px_rgba(0,0,0,0.5)]">
        ...
        {gameOver && (
          <div className="absolute inset-0 flex flex-col items-center justify-center bg-black/80 backdrop-blur-sm">
            <h2 className="text-6xl font-black text-red-600 mb-4 italic animate-pulse">
              GAME OVER
            </h2>
